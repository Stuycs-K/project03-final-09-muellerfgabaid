...
const int destroyerLeft[2][1] = {{2}, {1}};

const int carrierQ1[2][2] = {{0, 2}, {1, 1}};
const int carrierQ2[2][2] = {{2, 0}, {1, 1}};
const int carrierQ3[2][2] = {{0, 1}, {2, 1}};
const int carrierQ4[2][2] = {{0, 1}, {1, 2}};
